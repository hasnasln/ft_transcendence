...
async function submit(e: Event): Promise<void> {
    ...
    const regUsername = document.getElementById("username") as HTMLInputElement;
...
const illustrationSvg = `<svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="608" height="495" viewBox="0 0 608 495" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M24.2629 275.388C24.2629 277.731 24.6893 279.974 25.4687 282.044C26.1171 283.766 25.673 285.782 24.2672 286.97C17.905 292.342 13.8644 300.378 13.8644 309.357C13.8644 312.534 14.3703 315.594 15.306 318.459C15.7918 319.946 15.3825 321.602 14.2203 322.65C5.48885 330.517 -0.000366211 341.913 -0.000366211 354.591C-0.000366211 378.328 19.2427 397.571 42.9803 397.571C66.7179 397.571 85.9609 378.328 85.9609 354.591C85.9609 342.031 80.5739 330.73 71.9843 322.871C70.83 321.815 70.4334 320.155 70.9307 318.672C71.9115 315.746 72.4428 312.613 72.4428 309.357C72.4428 300.378 68.4022 292.342 62.04 286.97C60.6342 285.782 60.1901 283.766 60.8385 282.044C61.6179 279.974 62.0443 277.731 62.0443 275.388C62.0443 264.955 53.5867 256.498 43.1536 256.498C32.7205 256.498 24.2629 264.955 24.2629 275.388Z" fill="#1F2A37"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M43.3271 274.215C42.7749 274.215 42.3271 274.663 42.3271 275.215L42.3271 441.245C42.3271 441.798 42.7749 442.245 43.3271 442.245C43.8794 442.245 44.3271 441.798 44.3271 441.245L44.3271 275.215C44.3271 274.663 43.8794 274.215 43.3271 274.215Z" fill="#374151"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M23.6814 349.271C23.232 349.592 23.1279 350.217 23.4489 350.666L42.5129 377.356C42.8339 377.805 43.4584 377.909 43.9079 377.588C44.3573 377.267 44.4614 376.643 44.1404 376.193L25.0764 349.504C24.7553 349.054 24.1308 348.95 23.6814 349.271Z" fill="#374151"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M62.9719 308.023C63.4213 308.344 63.5254 308.969 63.2044 309.418L44.1404 336.108C43.8194 336.557 43.1949 336.661 42.7455 336.34C42.2961 336.019 42.192 335.395 42.513 334.945L61.577 308.256C61.898 307.806 62.5225 307.702 62.9719 308.023Z" fill="#374151"/>
                        <path d="M70.2715 417.336C70.3214 416.199 69.4124 415.249 68.2734 415.249H18.0336C16.8947 415.249 15.9856 416.199 16.0355 417.336L19.3263 492.365C19.3732 493.435 20.2539 494.278 21.3244 494.278H64.9827C66.0531 494.278 66.9338 493.435 66.9807 492.365L70.2715 417.336Z" fill="#374151"/>
                        <path d="M70.2715 417.336C70.3214 416.199 69.4124 415.249 68.2734 415.249H18.0336C16.8947 415.249 15.9856 416.199 16.0355 417.336L19.3263 492.365C19.3732 493.435 20.2539 494.278 21.3244 494.278H64.9827C66.0531 494.278 66.9338 493.435 66.9807 492.365L70.2715 417.336Z" fill="url(#paint1_linear_182_7947)"/>
                        <path d="M147.659 6.00001C147.659 2.68631 150.345 0 153.659 0H466.787C470.101 0 472.787 2.68629 472.787 6V310.809C472.787 314.123 470.101 316.809 466.787 316.809H153.659C150.345 316.809 147.659 314.123 147.659 310.809V6.00001Z" fill="#1F2A37"/>
                        <path d="M355.284 78.162C355.284 102.952 335.187 123.049 310.397 123.049C285.606 123.049 265.51 102.952 265.51 78.162C265.51 53.3715 285.606 33.2749 310.397 33.2749C335.187 33.2749 355.284 53.3715 355.284 78.162Z" fill="#374151"/>
                        ...
                        <path d="M310.137 76.3858C313.906 76.3858 316.961 73.3305 316.961 69.5617C316.961 65.7929 313.906 62.7377 310.137 62.7377C306.368 62.7377 303.313 65.7929 303.313 69.5617C303.313 73.3305 306.368 76.3858 310.137 76.3858Z" fill="#1F2A37"/>
                        <path d="M306.237 82.2349H314.036C316.105 82.2349 318.088 83.0566 319.551 84.5192C321.014 85.9818 321.835 87.9655 321.835 90.0338V93.9333H298.438V90.0338C298.438 87.9655 299.26 85.9818 300.723 84.5192C302.185 83.0566 304.169 82.2349 306.237 82.2349Z" fill="#1F2A37"/>
                        ...
                        <linearGradient id="paint1_linear_182_7947" x1="-49.3589" y1="468.867" x2="108.197" y2="468.867" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#1F2A37"/>
                        <stop offset="1" stop-color="#1F2A37" stop-opacity="0"/>
                        </linearGradient>
...
export function renderRegister(container: HTMLElement): void {
    ...
    const showLoginBtn = container.querySelector("#show-login") as HTMLButtonElement;

    showLoginBtn.onclick = () => Router.getInstance().go('/login');
    registerForm.onsubmit = (e: Event) => {
        e.preventDefault();
        submit(e);
    };
}