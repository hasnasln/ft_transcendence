...
export class HomePage {
    ...
    currentLanguage; // Mevcut dili saklamak için
    isInitialRender = true; // İlk render kontrolü
    constructor() {
    ...
    handleSettings() {
        ...
        hsn.render(document.getElementById('content-container'));
    }
    handleProfile() {
...
export function renderHome(container) {
    ...
    profiles.forEach((profile, i) => {
        const card = createProfileCard(profile.name, profile.linkedin, profile.github, profile.avatar);
...
function createProfileCard(name, linkedin, github, avatar) {
...
function createModernButton(container, text, action, floaterBgColor, floaterBorderColor, textColor, iconBorderColor, iconBgColor, icon) {
