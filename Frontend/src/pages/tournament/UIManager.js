...
export class TournamentUIManager {
    createTournamentStartedInfoHTML() {
        return `
    ...
    createCanStartInfoHTML(playerCount) {
        return `
    ...
    showActionError(target, message) {
    ...
    findTournamentContainer() {
        let container = document.getElementById('tournament-main');
        if (!container) {
            const contentContainer = document.getElementById('content-container');
            if (contentContainer) {
                const tournamentContainer = contentContainer.querySelector('#tournament-main');
                if (tournamentContainer) {
                    container = tournamentContainer;
                }
                else {
                    const tournamentDiv = contentContainer.querySelector('[id*="tournament"]');
                    if (tournamentDiv) {
