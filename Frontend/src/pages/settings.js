...
export class Settings {
    ...
    updateLanguageDisplay(button, lang, flags, names) {
        button.innerHTML = `
    ...
    close() {
        ...
        const settingsMain = document.getElementById('settings_main');
        if (settingsMain) {
            const sidebar = settingsMain.querySelector('div:last-child');
