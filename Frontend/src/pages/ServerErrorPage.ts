...
export class ServerErrorPage implements Page {
    ...
    public static readonly illustration = `<svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="610" height="258" viewBox="0 0 610 258" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path fill-rule="evenodd" clip-rule="evenodd" d="M508 25C509.657 25 511 23.6569 511 22C511 20.3431 509.657 19 508 19C506.343 19 505 20.3431 505 22C505 23.6569 506.343 25 508 25ZM508 26C510.209 26 512 24.2091 512 22C512 19.7909 510.209 18 508 18C505.791 18 504 19.7909 504 22C504 24.2091 505.791 26 508 26Z" fill="#111928"/>
		...
		<path fill-rule="evenodd" clip-rule="evenodd" d="M526 68C527.657 68 529 66.6569 529 65C529 63.3431 527.657 62 526 62C524.343 62 523 63.3431 523 65C523 66.6569 524.343 68 526 68ZM526 69C528.209 69 530 67.2091 530 65C530 62.7909 528.209 61 526 61C523.791 61 522 62.7909 522 65C522 67.2091 523.791 69 526 69Z" fill="#111928"/>
		<path fill-rule="evenodd" clip-rule="evenodd" d="M544 68C545.657 68 547 66.6569 547 65C547 63.3431 545.657 62 544 62C542.343 62 541 63.3431 541 65C541 66.6569 542.343 68 544 68ZM544 69C546.209 69 548 67.2091 548 65C548 62.7909 546.209 61 544 61C541.791 61 540 62.7909 540 65C540 67.2091 541.791 69 544 69Z" fill="#111928"/>
		...
		<path fill-rule="evenodd" clip-rule="evenodd" d="M582.539 63.7251L583.539 60.2251L585.462 60.7745L584.462 64.2745L582.539 63.7251Z" fill="#6B7280" fill-opacity="0.3"/>
		<path fill-rule="evenodd" clip-rule="evenodd" d="M588.02 63.1959L587.52 60.6959L589.481 60.3037L589.981 62.8037L588.02 63.1959Z" fill="#6B7280" fill-opacity="0.3"/>
		<path fill-rule="evenodd" clip-rule="evenodd" d="M593.375 59.781L590.875 57.781L592.124 56.2192L594.624 58.2192L593.375 59.781Z" fill="#6B7280" fill-opacity="0.3"/>
		...
		<path fill-rule="evenodd" clip-rule="evenodd" d="M83.5 51C83.5 49.067 85.067 47.5 87 47.5H406C407.933 47.5 409.5 49.067 409.5 51V248H406.5V51C406.5 50.7239 406.276 50.5 406 50.5H87C86.7239 50.5 86.5 50.7239 86.5 51V248H83.5V51Z" fill="#111928"/>
		<path fill-rule="evenodd" clip-rule="evenodd" d="M83.5 51C83.5 49.067 85.067 47.5 87 47.5H406C407.933 47.5 409.5 49.067 409.5 51V248H406.5V51C406.5 50.7239 406.276 50.5 406 50.5H87C86.7239 50.5 86.5 50.7239 86.5 51V248H83.5V51Z" fill="url(#paint13_linear_275_1516)"/>
	    ...
	    <section class="bg-white dark:bg-gray-900">
	      <div class="container flex items-center justify-center min-h-screen px-6 py-12 mx-auto">
	        <div class="flex flex-col items-center max-w-lg text-center">
	          ${ServerErrorPage.illustration}
	          <h2 class="mt-6 text-3xl font-semibold text-gray-800 dark:text-white md:text-4xl">Internal server error</h2>
	          <p class="mt-4 text-gray-500 dark:text-gray-400">Sorry, something went wrong on our end.</p>
