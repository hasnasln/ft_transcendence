...
export function updateScoreBoard(gameInfo) {
...
export function updateSetBoard(gameInfo) {
    if (gameInfo.state?.isPaused)
        return;
...
export function showSetToast(gameInfo, message) {
...
export async function startNextSet(gameInfo) {
...
export function showEndMessage(gameInfo) {
