...
function aa(name_one: string, name_two?: string): HTMLElement {
...
function rount(container: HTMLElement)
{
...
function rount2(container: HTMLElement)
{
...
export function getTournamentTree(container: HTMLElement, count: number): void {
...
function hcoskun_tree_view(participants: any[]): string {
    let result: string = "";
...
function hcoskun_round_tree(participants: any[]): string {
    return `
...
function hcoskun_round_list(participants: any[]): string {
    return participants
        .map((p) => `
