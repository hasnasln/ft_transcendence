...
export function moveButton(container, p) {
    ...
    controler_container.classList.add('absolute', 'flex', 'flex-col', 'items-center', 'justify-center', 'w-[100px]', 'h-[100px]', 'gap-[1vw]');
    if (p === 'left') {
        controler_container.classList.add('bottom-[4%]', 'left-[10%]');
    }
    else if (p === 'right') {
        controler_container.classList.add('bottom-[4%]', 'right-[10%]');
    }
    const up_b = document.createElement('div');
    up_b.id = 'move-button-up' + (p);
    up_b.textContent = '^';
    up_b.classList.add('px-3', 'py-1', 'text-xl', 'text-white', 'border-none', 'rounded-[8px]', 'cursor-pointer', 'z-30', 'bg-red-500', 'z-[1000]', 'active:bg-red-700', 'rounded-full');
    ...
    down_b.classList.add('px-3', 'py-1', 'text-xl', 'text-white', 'border-none', 'rounded-[8px]', 'cursor-pointer', 'z-30', 'bg-blue-500', 'z-[1000]', 'active:bg-blue-700', 'rounded-full');
