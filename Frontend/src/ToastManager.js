...
export class ToastManager {
    ...
    static ShowToast(type, langm_key, position = "right", duration = 3000) {
    ...
    static onloadToast(toast, duration) {
        ...
        requestAnimationFrame(() => {
            ...
            const progressBar = toastElemet.querySelector('.absolute.bottom-0');
            if (progressBar) {
                setTimeout(() => {
