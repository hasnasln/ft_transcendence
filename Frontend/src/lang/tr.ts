export const tr  = {
	...
	"game":{
		...
		"InfoMessage": {
			"unexpected_try_refresh" : "Beklenmedik bir hata oluştu, lütfen sayfayı yenilemeyi deneyin.",
			"connection_lost": "Ağ bağlantısı kesildi, Maçınız bitirilecek.",
			"network_lost_reconnect_countdown" : "Ağ bağlantısı kesildi, yeniden bağlanmaya çalışılıyor. {s} saniye sonra yeniden bağlanılacak.",
			"reconnected_request_permission": "Bağlantı yeniden kuruldu, Oyuna katılma izinizi bekliyoruz.",
			"permission_granted_joining": "İzin verildi, Oyuna katılınıyor...",
			"permission_denied_redirect_home": "İzin reddedildi, Ana sayfaya yönlendiriliyorsunuz.",
			"match_cancelled_redirect_home": "Maç iptal edildi, Ana sayfaya yönlendiriliyorsunuz.",
			"connection_failed": "Ağ bağlantısı başarısız oldu: {error}",
			"connection_ready": "Ağ bağlantısı hazır",
			"waiting_tournament_opponent": "Turnuva rakibi bekleniyor...",
			"waiting_online_opponent": "Çevrim içi rakip bekleniyor...",
			"waiting_specific_opponent": "{opponent} bekleniyor...",
			"opponent_disconnected_waiting": "Rakip bağlantısı kesildi. Bekleniyor...",
			"opponent_reconnected": "Rakip yeniden bağlandı, oyuna devam ediliyor...",
			"connection_rejected_duplicate_session": "Bağlantı reddedildi, başka bir cihazda oturum açık.",
			"reconnect_failed": "Yeniden bağlanma başarısız oldu, lütfen sayfayı yenileyin.",
			"request_sent_to_rival": "Tlebiniz {rival} oyuncusuna iletildi.",
			"match_starting": "Maç başlıyor...",
			"rival_no_confirmation": "{rival} oyuncusundan onay gelmedi!",
			"round_advanced": "Tur atlandı, yeni tur başlatılıyor...",
			"next_match_final_vs_rival": "Sonraki maç: {rival} ile final maçı",
			"next_match_round_vs_rival" : "Sonraki maç: {rival} ile {round}. tur maçı",
			"matched_with_rival": "{rival} ile eşleştirildiniz.",
		},
		"EndMessage":{
			"match_winner": "Maçı {winner} kazandı!",
			"tournament_winner": "{tournament} turnuvasını {winner} kazandı. Tebrikler !",
			"disconnected_match_ended": "Rakip bağlantısı kesildi, maç sona erdi.",
		...
		"Errors" : {
			...
			"eliminated": "Turnuvadan elendiniz",
			"not_registered": "Turnuvaya kayıtlı değilsiniz",
			"no_active_round": "Aktif tur yok",
			"qualified_next_round": "Bir sonraki tura yükseldiniz",
			"already_played":"Bu turdaki maçınızı zaten oynadınız, bir sonraki turu bekleyin",
			"match_ongoing": "Maç zaten devam ediyor",
			"match_already_completed": "Maçınız zaten tamamlandı",
			"match_cancelled": "Maç iptal edildi",
			"TOURNAMENT_WINNER_COULD_NOT_BE_UPDATED":" Turnuva kazananı güncellenemedi.",
		},
		"loading": "Yükleniyor...",
